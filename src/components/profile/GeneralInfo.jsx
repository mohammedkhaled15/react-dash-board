...
const GeneralInfo = () => {
    return (
        <article className='grid grid-cols-4 py-4 px-2 justify-start col-span-12'>
            <aside className="col-span-1 flex flex-col gap-2 justify-center items-center">
            ...
            <main className="col-span-3 flex flex-col gap-1 mt-4">
                {
                    information.map((info, index) =>
                        <section key={index} className="">
                            <h6 className="mb-4 text-text-gray font-bold">{info.name}</h6>
                            <div className="flex flex-row gap-4 justify-start">
                                <h6 className="text-xs  font-thin"><span className="text-text-gray font-bold">{info.info1T}</span> {info.info1S}</h6>
                                <h6 className="text-xs  font-thin"><span className="text-text-gray font-bold">{info.info2T}</span> {info.info2S}</h6>
                                <h6 className="text-xs  font-thin"><span className="text-text-gray font-bold">{info.info3T}</span> {info.info3S}</h6>
                            </div>
